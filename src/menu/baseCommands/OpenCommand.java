...
/**
 * The OpenCommand class implements the Commands interface.
 * It is responsible for executing an open operation, which is defined by the given Operation instance.
 */
public class OpenCommand implements Commands {
    private final Operation operation;

    /**
     * Constructs an OpenCommand with the specified Operation.
     *
     * @param operation The operation to be executed.
     */
    public OpenCommand(Operation operation) {
        this.operation = operation;
    }

    /**
     * Executes the open operation using the provided EventBooker, Halls, and data.
     *
